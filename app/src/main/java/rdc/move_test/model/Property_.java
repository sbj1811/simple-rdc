...
public class Property_ implements Serializable
{
    ...
    @SerializedName("display_address_line")
    @Expose
    private Boolean displayAddressLine;
    @SerializedName("baths_half")
    @Expose
    private Integer bathsHalf;
    private final static long serialVersionUID = 8043155139257140742L;
    ...
    public Boolean getDisplayAddressLine() {
        return displayAddressLine;
    }

    public void setDisplayAddressLine(Boolean displayAddressLine) {
        this.displayAddressLine = displayAddressLine;
    }
